...
// CanvasPlayer owns generated Canvas frames and the playback goroutine that advances them.
...
// NewCanvasPlayer returns an idle CanvasPlayer with no loaded frames.
func NewCanvasPlayer() *CanvasPlayer {
	return &CanvasPlayer{}
}

// Load replaces the current Canvas with JPEG frames generated by ffmpeg.
...
// Play starts frame cycling and calls onTick with each frame path.
...
// Stop halts frame cycling without removing loaded frames.
...
// Clear stops playback, forgets frames, and removes generated frame files.
...
// HasFrames reports whether a Canvas has been loaded.
...
// IsPlaying reports whether frame cycling is active.
...
// CurrentFrame returns the current generated frame path, or "" when no frames are loaded.
