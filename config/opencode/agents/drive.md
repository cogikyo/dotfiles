...
The Kimi preflight above is mandatory even when ordinary routing would skip a refresh, kimi block until usage is availble and hault a task if at capacity.
