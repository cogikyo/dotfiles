...
If the same permission would be useful in future debugger reviews but agent-system edits are out of scope, explicitly suggest the permission rule to add.
Manage `skills/review/scripts/debugger.sh`.
