return {
	...
	keys = {
		...
		{ "<leader>nt", function() require("harpoon.ui").nav_file(1) end, desc = "Slot 1 · T" },
		{ "<leader>ne", function() require("harpoon.ui").nav_file(2) end, desc = "Slot 2 · E" },
		{ "<leader>ns", function() require("harpoon.ui").nav_file(3) end, desc = "Slot 3 · S" },
		{ "<leader>na", function() require("harpoon.ui").nav_file(4) end, desc = "Slot 4 · A" },
