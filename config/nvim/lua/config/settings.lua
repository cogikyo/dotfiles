...
local options = {
	...
	textwidth = 100, -- max line length for formatting (gq)
	smoothscroll = true, -- scroll by screen line, not text line

	hlsearch = true, -- highlight all search matches
	shortmess = "filnxtToOFcsSIC", -- shorten/suppress various messages
	...
	colorcolumn = "80,100,120", -- visual guides for line length
